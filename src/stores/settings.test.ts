...
const CHECKS: { name: string; check: SourceCheck }[] = [
  {
    ...
    check: {
      forbidden: [
        ...
        'getItem("project-dev:view")',
        'getItem("project-dev:sort")',
        'removeItem("project-dev:view")',
        'removeItem("project-dev:sort")',
      ],
